...
class TablaPedidos
{
    ...
    public function mostrarTablaPedidosEnviados(){
        ...
        for ($i = 0; $i < count($pedidos); $i++){
            ...
            /*=============================================
                ...
                =============================================*/
                $acciones = "<button class='btn btn-success btn-sm btnEnviadoPedido' idPedidoF='" . $pedidos[$i]["pedido"] . "'>Información pedido</button>";
...
$mostrarPedidos->mostrarTablaPedidosEnviados();
