<div class="retorno">
    ...
    <div class="btnnuevo container">
        <a id="" class="btn btn-sm rounded float-left" href="menu" data-toggle="modal" data-target="#ModalCrearUsuario" role="button">
        <lord-icon
...
<div class="card container shadow p-3 mb-5 bg-white rounded animate__animated animate__fadeInUp">
  <div class="card-body">
    <div class="table-responsive-sm">
            <table class="table table-striped" style="width:100%" id="tablaUsuarios">
        <thead>
            <tr>
...
<div class="modal fade" id="ModalCrearUsuario" data-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group col-sm-6">
                        <label for="rol_id" class="col-form-label col-form-label-sm">Rol</label>
                        <select class="form-control form-control-sm rounded" name="rol_id" id="rol_id" required>
                            <option selected value="">Seleccione...</option>
