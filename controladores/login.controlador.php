        ...
        if (isset($_POST["usuario"])) {
                ...
                if(is_array($respuesta)){
                    if (password_verify($encriptar, $respuesta['password'])) {
                        ...
                        elseif($respuesta["rol_id"] == 2){
                            
                            echo '<script>
    
                                window.location = "embalaje";
    
                            </script>';
                        }

                        elseif($respuesta["rol_id"] == 3){
                            
                            echo '<script>
    
                                window.location = "bodega";
                        ...
                        echo '<br>
                        <div class="alert alert-warning">Este usuario esta inactivo</div>';
                    ...
                    <span class="badge bg-danger">Usuario Incorrecto</span>
                    </div>';
                ...
                echo '<br>
                    <div class="text-center">
                    <span class="badge bg-danger">Campos Vacios</span>
                    </div>';
            }
